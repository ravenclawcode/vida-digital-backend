<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('counselors.index')" :active="request()->routeIs('counselors.index')">
                        {{ __('Manajemen Konselor') }}
                    </x-nav-link>
                    <x-nav-link :href="route('tokens.index')" :active="request()->routeIs('tokens.index')">
                        {{ __('Generate Token User') }}
                    </x-nav-link>
                    <x-nav-link :href="route('audio.index')" :active="request()->routeIs('audio.*')">
                        {{ __('Manajemen Audio') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('audio.index')" :active="request()->routeIs('audio.*')">
                {{ __('Manajemen Audio') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('education.index')" :active="request()->routeIs('education.*')">
                {{ __('Konten Edukasi') }}
            </x-responsive-nav-link>
        </div>
