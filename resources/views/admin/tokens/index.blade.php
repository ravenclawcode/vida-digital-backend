        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-600">Buat kode unik untuk pasien baru agar mereka dapat mendaftar secara anonim.</p>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="p-4 border-b text-center">
                                    ...
                                    @else
                                        <span class="text-green-600 bg-green-100 px-3 py-1 rounded-full text-xs font-semibold">
                                            Tersedia
                                        </span>
                                    @endif
                                </td>
                                ...
                                <td class="p-4 border-b text-center">
                                    @if(!$token->is_used)
                                        <form action="{{ route('tokens.destroy', $token->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus token yang belum terpakai ini?')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="text-red-500 hover:text-red-700 transition" title="Hapus Token">
                            ...
                            @empty
                            <tr>
                                <td colspan="4" class="p-8 text-center text-gray-400 italic">Belum ada token yang dibuat.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
