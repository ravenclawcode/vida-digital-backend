                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            <x-modal name="detail-soap-{{ $soap->id }}" focusable>
                                <div class="p-6 text-gray-900">
                                    <h2 class="text-xl font-bold border-b pb-3 text-gray-800 uppercase tracking-wide">Detail Catatan SOAP</h2>

                                    <div class="mt-4 grid grid-cols-2 text-[12px] text-gray-500 gap-2 mb-6">
